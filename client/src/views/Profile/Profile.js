      ...
      {profile === null ? (
        ...
        <div>
          <List dense style={{ marginBottom: "20px" }}>
            {profilePicModal.isVisible &&
              profile &&
              auth.user._id === profile.user && <ProfilePicModal />}
            ...
            <ListItem>
              <ListItemText
                primary={
                  profile &&
                  (profile.name === null ? auth.user.name : profile.name)
                }
              />
              {profile &&
            ...
            <ListItem style={{ marginTop: "15px" }}>
              ...
              <span>
                <ListItemText
                  primary={
                    profile &&
                    "Joined: " + new Date(profile.date).toDateString()
                  }
                />
              </span>
            </ListItem>
