...
const FollowerGrid = ({ getProfileById, profile: { profile },
  auth, },  props) => {
  ...
  const classes = useStyles()
    return (<div className={classes.root}>
      <GridList cellHeight={160} className={classes.gridList} cols={4}>
        {!profile ? '' : profile.followers.map((person, i) => {
...
export default connect(mapStateToProps, { getProfileById })(FollowerGrid)